...
function waterScheduler(){
	...
	$('.modal-title').html('Water Change scheduler')
	
	jQuery.ajax({
		type: 'GET',
		url: api + '/water/getWaterSchedule',
		dataType: 'json', 
...
function saveWater(data){
		...
		$.ajax( api + '/water/setWaterSchedule?schedule='+encodeURI(saveBack))
		  .done(function( data ) {
		 });
